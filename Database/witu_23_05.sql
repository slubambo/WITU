...
CREATE TABLE `course` (
  ...
  `minWeeks` int(11) DEFAULT NULL COMMENT 'in months',
  `maxWeeks` int(11) DEFAULT NULL,
  `minHoursWeekly` int(11) DEFAULT NULL,
  `maxHoursWeekly` int(11) DEFAULT NULL,
  `courseCategoryId` int(11) unsigned NOT NULL,
  `creators` varchar(255) DEFAULT NULL,
  `campusId` int(10) unsigned DEFAULT NULL COMMENT 'Null if Course is in all campuses',
  PRIMARY KEY (`id`),
...
-- Records of course
-- ----------------------------
INSERT INTO `course` VALUES ('1', 'Starting Your Own Business ', '<p>Any aspiring business person has to come to terms with basic concepts associated with a business. Throughout this course, we intend to discuss concepts like \'entrepreneurship\', \'entrepreneur\', \'enterprise\', \'the business idea\', and factors that influen', '0', '1', 'Pass all assignments to complete the course.', '3', '5', '3', '6', '1', 'WITU, Makerere University', '1');
INSERT INTO `course` VALUES ('2', 'Mobile Phone Repair', '<p>Acquire skills in repairing commonly used electronics especially mobile phones</p>', '0', '1', 'Pass all assignments to complete the course.', '2', '6', '4', '5', '2', 'WITU', '2');
...
-- ----------------------------
INSERT INTO `course_category` VALUES ('1', 'Business', null, null, null);
INSERT INTO `course_category` VALUES ('2', 'Technology', null, null, null);
INSERT INTO `course_category` VALUES ('3', 'Leadership', null, null, null);
INSERT INTO `course_category` VALUES ('4', 'Life Skills', null, null, null);
...
CREATE TABLE `syllabus` (
  ...
  `overview` text,
  `graded` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `ICourseSyllabus` (`courseId`),
  CONSTRAINT `FKCourseSyllabus` FOREIGN KEY (`courseId`) REFERENCES `course` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=latin1;

-- ----------------------------
-- Records of syllabus
-- ----------------------------
INSERT INTO `syllabus` VALUES ('1', '1', '1', 'Is Entrepreneurship for You? ', 'Welcome to Starting Your Own Business! You decided to take this course because you want to become an entrepreneur. This means you want to start and run your own business in your community. You may already have a great business idea… or not… but you kno', null);
INSERT INTO `syllabus` VALUES ('2', '1', '2', 'What Is Entrepreneurship? ', 'In Unit 1 you looked at what it takes to be an entrepreneur and you decided you wanted to become one! If you are already a small business owner, you decided that you wanted to grow your business in a sustainable manner. This could be a very exciting an', null);
INSERT INTO `syllabus` VALUES ('3', '1', '3', 'Planning For the Business ', 'You are now into the third unit of Starting Your Own Business. We hope that you found the first couple of units interesting to follow and relevant to your own situation of wanting to become an entrepreneur. You may have found some study areas challengi', null);

-- ----------------------------
-- Table structure for `syllabus_attachment`
-- ----------------------------
DROP TABLE IF EXISTS `syllabus_attachment`;
CREATE TABLE `syllabus_attachment` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  ...
  `description` text,
  PRIMARY KEY (`id`),
  KEY `ISyllabusAttachment` (`syllabusId`),
  CONSTRAINT `FKSyllabusAttachment` FOREIGN KEY (`syllabusId`) REFERENCES `syllabus` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- ----------------------------
-- Records of syllabus_attachment
-- ----------------------------

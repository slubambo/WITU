...
namespace WITU.API.UserManagement.Store
{
        ...
        IUserPasswordStore<IdentityUser, int>, IUserLoginStore<IdentityUser, int>, IRoleStore<IdentityRole, int>
    {
        ...
        public Task<IdentityUser> FindByIdAsync(int userId)
        {
            ...
            switch (user.UserType)
            {
                case (int)UserTypes.Instructor:
                    var staff = _accountRepository.GetUserInstructor(user);
                    profilePhoto = staff.Person != null ? staff.Person.ProfilePhotoName : null;
                    break;
        ...
        public Task UpdateAsync(IdentityUser user)
        {
            ...
            actualUser.Password = user.PasswordHash.ToString();
